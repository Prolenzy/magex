...
import { FaArrowRight, FaEnvelope, FaUser } from 'react-icons/fa'; // Import the icon
...
const ContactUs = () => {
  return (
    ...
    text-gray-700'>
        ...
        <form onSubmit={onS} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            <div>
            ...
            <div className='sm:col-span-2'>
                ...
                outline-none rounded-lg border border-gray-300' required />
            </div>
            ...
            <button
                ...
                >
                Submit <FaArrowRight size={16} className='w-4' />
            </button>
        </form>
    </div>
  )
