...
const Hero = () => {
  return (
    ...
    xl:px-40 text-center w-full overflow-hidden text-gray-700'>
        ...
        <p className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/'>creating meaningful connections and turning big ideas into interactive digital 
            experiences</p>
    </div>
  )
}
