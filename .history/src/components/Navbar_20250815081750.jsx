...
const Navbar = () => {
  ...
  return (
    ...
    sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
        ...
        <img src='/dox1.png' className='w-32 sm:w-40' alt=''/>
        ...
        flex sm:items-center gap-5 transition-all`}>
             ...
             <img src='/ter1.png' alt='' className='w-5 absolute right-4 top-4 sm:hidden' 
        ...
        <div className='flex items-center gap-2 sm:gap-4'>
            ...
            <img src='/2001.png alt=onClick={() => setSidebarOpen(true)} className='w-8 sm:hidden''
            ...
            hover:scale-103 transition-all'>
                Connect <img src='/vay1.png' width={14} alt=''/>
            </a>
        </div>
    </div>
  )
