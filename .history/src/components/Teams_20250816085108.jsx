  ...
  const teamData = [
    {
      name: 'Wanjiku Mwangi',
      title: 'CEO & Founder',
      image: '/team/wanjiku-ceo.jpg' // Kenyan female executive
    },
    {
      name: 'Kamau Otieno',
      title: 'Vice President',
      image: '/team/kamau-vp.jpg' // Kenyan male professional
    },
    {
      name: 'Auma Okoth',
      title: 'Performance Manager',
      image: '/team/auma-pm.jpg' // Kenyan female manager
    },
    {
      name: 'Juma Were',
      title: 'Ads Manager',
      image: '/team/juma-ads.jpg' // Kenyan male marketer
    },
    {
      name: 'Nyambura Kariuki',
      title: 'Content Writer',
      image: '/team/nyambura-writer.jpg' // Kenyan female writer
    },
    {
      name: 'Omondi Onyango',
      title: 'Content Marketer',
      image: '/team/omondi-marketer.jpg' // Kenyan male professional
    },
    {
      name: 'Adhiambo Atieno',
      title: 'Marketing & Sales',
      image: '/team/adhiambo-sales.jpg' // Kenyan female sales executive
    },
    {
      name: 'Mwangi Githinji',
      title: 'Senior Writer',
      image: '/team/mwangi-senior-writer.jpg' // Kenyan male senior professional
    }
  ];
