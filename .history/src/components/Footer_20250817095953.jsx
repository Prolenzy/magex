...
const Footer = () => {
  return (
    <div className='bg-slate-50 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        ...
        {/* Footer bottom */}
        <div className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-w'>
            ...
            <div className='flex items-center justify-between gap-4'>
                    ...
                    <a href='https://x.com/pizzchzz' target='_blank' rel='noopener noreferrer' aria-label='Twitter' 
                    className='hover:text-white transition-colors duration-300'>
                        <FaTwitter size={24} />
                    </a>
                    <a href='https://www.linkedin.com/in/charles-kimotho-full-stack-developer/' target='_blank' 
                    rel='noopener noreferrer' aria-label='LinkedIn' className='hover:text-white transition-colors 
                    duration-300'> <FaLinkedin size={24} />
                    </a>
                    <a href='https://github.com/Prolenzy' target='_blank' rel='noopener noreferrer' aria-label='GitHub'
                     className='hover:text-white transition-colors duration-300'>
                        <FaGithub size={24} />
                    </a>
                </div>
