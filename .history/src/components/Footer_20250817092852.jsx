...
const Footer = () => {
  return (
    <div className='bg-slate-50 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        ...
        {/* Footer bottom */}
        <div>
            <p>&copy; 2025 <a href='https://contentandcodebycharles.com/' target='_blank' rel='noopener noreferrer' className='hover:underline'>Content & Code by Charles</a> - All Rights Reserved.</p>
        </div>
    </div>
  )
}
