...
const Navbar = () => {
  return (
    ...
    sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
        ...
        <div className='text-gray-700 sm:text-sm max-sm:w-60 max-sm:pl-10 max-sm:fixed
        ...
        <div>
            <a href='#contact-us' className='text-sm max-sm:hidden flex items-center gap'>
                Connect <img src='' width={14} alt=''/>
            </a>
        </div>
    </div>
  )
