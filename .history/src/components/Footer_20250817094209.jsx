    ...
    <div className='bg-slate-50 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        ...
        <div>
            ...
            <div className='flex gap-4'>
                    <a href='https://www.facebook.com/kimotho.kyalo' target='_blank' rel='noopener noreferrer' aria-label='Facebook' className='hover:text-white transition-colors duration-300'>
                        <FaFacebook size={24} />
                    </a>
