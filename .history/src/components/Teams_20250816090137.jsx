...
const Teams = () => {
  const teamData = [
    ...
    },
    {
      ...
      image: '/kamau-vp.jpeg' // Kenyan male professional
    },
    {
      name: 'Auma Okoth',
      title: 'Performance Manager',
      image: '/auma-pm.jpeg' // Kenyan female manager
    },
    {
      name: 'Juma Were',
      title: 'Ads Manager',
      image: '/juma-ads.jpeg' // Kenyan male marketer
    },
    {
    ...
    },
    {
      ...
      image: '/omondi-marketer.jpeg' // Kenyan male professional
    },
    {
      name: 'Adhiambo Atieno',
      title: 'Marketing & Sales',
      image: '/adhiambo-sales.jpeg' // Kenyan female sales executive
    },
    {
      name: 'Mwangi Githinji',
      title: 'Senior Writer',
      image: '/mwangi-senior-writer.jpeg' // Kenyan male senior professional
    }
  ];
